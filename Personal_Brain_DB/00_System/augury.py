...
用法：
  ...
  python3 augury.py --correct 30_Journal/2024/workus.md --remove-location "台灣" --add-location "Osaka"
...
def correct_memory(file_path: str, corrections: list[tuple[str, str, str]]):
    ...
    corrections: list of (field, action, value)
      e.g. [("locations", "remove", "台灣"), ("locations", "add", "Osaka")]
    """
...
2. Locations must be SEMANTICALLY correct — if text says "在Osaka工作" but enrichment says "台灣", that's WRONG
...
def main():
    ...
    if args.correct:
        ...
        if not corrections:
            ...
            print('      --remove-location "台灣" --add-location "Osaka"\n')
            return
