...
林君的個人記憶資料庫。所有 AI 對話、手札、Profile 集中存放，支援語義搜尋，可掛載為 MCP Server 讓 Agent 存取。
...
```bash
python3 00_System/vectorize.py --query "深圳工作" --top 5
...
# → /Users/chun/.virtualenvs/personal-memory/bin/python
```
...
```json
{
  "mcpServers": {
    "personal-brain": {
      "command": "/Users/chun/.virtualenvs/personal-memory/bin/python",
      "args": [
        "/Users/chun/Documents/Python/personal-memory/Personal_Brain_DB/00_System/mcp_server.py"
      ]
    }
  }
}
